...
class PaymentController extends Controller
{
    ...
    {
        // GET requests to /payments/payment-request are not valid — redirect safely
    ...
    public function paymentRequest(Request $request)
    {
        ...
        try {
            ...
            if ($redirect_url instanceof \Symfony\Component\HttpFoundation\Response || $redirect_url instanceof \Illuminate\Contracts\View\View || $redirect_url instanceof \Illuminate\Contracts\Support\Renderable) {
                return $redirect_url;
            }
            ...
            \Log::error('PaymentRequest error: ' . $exception->getMessage());
    ...
    public function paymentVerify(Request $request, $gateway)
    {
        ...
        try {
            ...
            \Log::error('PaymentVerify error [' . $gateway . ']: ' . $exception->getMessage());
