                        ...
                        <div class="col-12 col-lg-5">
                            @if(!empty($themeFooterContent['cta']))
                                ...
                                @if(!empty($themeFooterContent['cta']['button']) and !empty($themeFooterContent['cta']['button']['label']))
                                    <a href="{{ (!empty($themeFooterContent['cta']['button']['url'])) ? $themeFooterContent['cta']['button']['url'] : '' }}" style="color: #222425;
    background-color: #c9b79c;" class="btn-flip-effect btn btn-xlg btn-primary gap-8 mt-32" data-text="{{ $themeFooterContent['cta']['button']['label'] }}">
