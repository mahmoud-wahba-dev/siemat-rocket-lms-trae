                ...
                <div class="d-flex-center flex-wrap gap-20 gap-lg-60 mt-48">
                    @foreach($themeFooterContent['specific_links'] as $specificLink1Data)
                        @if(!empty($specificLink1Data['title']) and !empty($specificLink1Data['url']))
                            <a href="{{ $specificLink1Data['url'] }}" target="_blank" style="background-color: #c9b79c;
    color: #1e1e1e;" class="btn-flip-effect btn-flip-effect__slow-effect btn-flip-effect__left-minus-54 text-white" data-text="{{ $specificLink1Data['title'] }}">
